  ...
  return (
    <header className="py-10 bg-indigo-600">
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center">
            ...
            <nav className="flex flex-col items-center lg:flex-row gap-4 lg:mt-0">
                <Link to="/admin text-white text-sm uppercase font-bold">Pacientes</Link>
                <Link to="/admin text-white text-sm uppercase font-bold">Perfil</Link>
